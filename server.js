...
app.use(helmet({
  contentSecurityPolicy: {
    directives: {
      ...
      connectSrc: ["'self'", "https://api.ipinfo.io", "https://website-backendd-1.onrender.com", "https://api.coingecko.com", "https://bithash-backend.onrender.com"],
...
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', 'https://www.bithashcapital.live');
...
const io = new Server(httpServer, {
  cors: {
    origin: ['https://bithhash.vercel.app', 'https://website-backendd-1.onrender.com', 'https://www.bithashcapital.live', 'https://bithash-backend.onrender.com'],
    methods: ['GET', 'POST']
  }
});
