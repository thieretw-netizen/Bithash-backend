  ...
  try {
    ...
    const generateStatementForUser = async (user) => {
      try {
        ...
        doc.fontSize(24).font('Helvetica-Bold').fillColor('#0B0E11').text('₿itHash Capital', leftMargin, y, { align: 'center', width: contentWidth });
        y = doc.y + 12;
        ...
        doc.fontSize(10).font('Helvetica-Bold').fillColor('#0B0E11').text('₿itHash Capital', leftMargin, y, { align: 'center', width: contentWidth });
        y += 16;
